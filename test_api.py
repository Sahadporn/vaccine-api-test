...
class reportTest(unittest.TestCase):
    ...
    def test_report_sent(self):
        ...
        citizen = requests.get(domain + "/registration/1139465027391")
        vaccine_taken = citizen.json()["vaccine_taken"]
        self.assertEqual(vaccine_taken, "['Astra']")
    ...
    def test_not_enough_key(self):
        ...
        self.assertIn(
            "The browser (or proxy) sent a request that this server could not understand.", response.text)
    ...
    def test_report_available_vaccine(self):
        ...
        citizen = requests.get(domain + "/registration/1139465027391")
        vaccine_taken = citizen.json()["vaccine_taken"]
        self.assertEqual(vaccine_taken, "['Astra', 'Astra']")
    ...
    def tearDown(self):
        requests.delete(domain + "/registration/1139465027391",
                        data=self.payload)
